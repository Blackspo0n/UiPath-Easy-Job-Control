...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class RobotDeletedEventDto :  IEquatable<RobotDeletedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RobotDeletedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RobotDeletedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RobotDeletedEventDto" /> class.
        /// </summary>
        ...
        public RobotDeletedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), List<WebhookRobotDto> Robots = default(List<WebhookRobotDto>), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for RobotDeletedEventDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for RobotDeletedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for RobotDeletedEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RobotDeletedEventDto);
        }

        /// <summary>
        /// Returns true if RobotDeletedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of RobotDeletedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RobotDeletedEventDto input)
        {
            if (input == null)
                return false;
