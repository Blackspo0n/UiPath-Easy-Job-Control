...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class RobotCreatedEventDto :  IEquatable<RobotCreatedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RobotCreatedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RobotCreatedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RobotCreatedEventDto" /> class.
        /// </summary>
        ...
        public RobotCreatedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), List<WebhookRobotDto> Robots = default(List<WebhookRobotDto>), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for RobotCreatedEventDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for RobotCreatedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for RobotCreatedEventDto and cannot be null");
            }
            else
            {
        ...
        public List<WebhookRobotDto> Robots { get; set; }
        ...
        {
            return this.Equals(input as RobotCreatedEventDto);
        }

        /// <summary>
        /// Returns true if RobotCreatedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of RobotCreatedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RobotCreatedEventDto input)
        {
            if (input == null)
                return false;
