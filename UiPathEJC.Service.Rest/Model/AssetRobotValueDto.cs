...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class AssetRobotValueDto :  IEquatable<AssetRobotValueDto>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetRobotValueDto" /> class.
        /// </summary>
        /// <param name="RobotId">The Id of the robot with which the asset is associated..</param>
        /// <param name="RobotName">The name of the robot with which the asset is associated..</param>
        ...
        public AssetRobotValueDto(long? RobotId = default(long?), string RobotName = default(string), string KeyTrail = default(string), ValueTypeEnum? ValueType = default(ValueTypeEnum?), string StringValue = default(string), bool? BoolValue = default(bool?), int? IntValue = default(int?), string Value = default(string), string CredentialUsername = default(string), string CredentialPassword = default(string), List<CustomKeyValuePair> KeyValueList = default(List<CustomKeyValuePair>), long? Id = default(long?))
        {
        ...
        /// </summary>
        /// <value>The Id of the robot with which the asset is associated.</value>
        ...
        /// </summary>
        /// <value>The name of the robot with which the asset is associated.</value>
        ...
        /// </summary>
        /// <value>Masked value of the robot key.</value>
        [DataMember(Name="KeyTrail", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  KeyTrail: ").Append(KeyTrail).Append("\n");
        ...
        {
            return this.Equals(input as AssetRobotValueDto);
        }

        /// <summary>
        /// Returns true if AssetRobotValueDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetRobotValueDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetRobotValueDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.KeyTrail == input.KeyTrail ||
                    (this.KeyTrail != null &&
                    this.KeyTrail.Equals(input.KeyTrail))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.KeyTrail != null)
                    hashCode = hashCode * 59 + this.KeyTrail.GetHashCode();
