...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class ReleaseDeletedEventDto :  IEquatable<ReleaseDeletedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseDeletedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReleaseDeletedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseDeletedEventDto" /> class.
        /// </summary>
        ...
        public ReleaseDeletedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), List<WebhookReleaseDto> Releases = default(List<WebhookReleaseDto>), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for ReleaseDeletedEventDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for ReleaseDeletedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for ReleaseDeletedEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ReleaseDeletedEventDto);
        }

        /// <summary>
        /// Returns true if ReleaseDeletedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ReleaseDeletedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReleaseDeletedEventDto input)
        {
            if (input == null)
                return false;
