...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class RobotDto :  IEquatable<RobotDto>, IValidatableObject
    {
        /// <summary>
        /// The Robot type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RobotDto" /> class.
        /// </summary>
        ...
        public RobotDto(string LicenseKey = default(string), string MachineName = default(string), long? MachineId = default(long?), string Name = default(string), string Username = default(string), string Description = default(string), string Version = default(string), TypeEnum Type = default(TypeEnum), HostingTypeEnum HostingType = default(HostingTypeEnum), string Password = default(string), CredentialTypeEnum? CredentialType = default(CredentialTypeEnum?), List<EnvironmentDto> Environments = default(List<EnvironmentDto>), string RobotEnvironments = default(string), Dictionary<string, Object> ExecutionSettings = default(Dictionary<string, Object>), long? Id = default(long?))
        {
            ...
            if (Username == null)
            {
                throw new InvalidDataException("Username is a required property for RobotDto and cannot be null");
            }
            else
            {
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for RobotDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (HostingType == null)
            {
                throw new InvalidDataException("HostingType is a required property for RobotDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RobotDto);
        }

        /// <summary>
        /// Returns true if RobotDto instances are equal
        /// </summary>
        /// <param name="input">Instance of RobotDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RobotDto input)
        {
            if (input == null)
                return false;
