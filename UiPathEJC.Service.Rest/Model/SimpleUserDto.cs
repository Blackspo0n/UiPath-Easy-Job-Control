...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class SimpleUserDto :  IEquatable<SimpleUserDto>, IValidatableObject
    {
        /// <summary>
        /// The user type.
        /// </summary>
        ...
        {
            return this.Equals(input as SimpleUserDto);
        }

        /// <summary>
        /// Returns true if SimpleUserDto instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleUserDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleUserDto input)
        {
            if (input == null)
                return false;
