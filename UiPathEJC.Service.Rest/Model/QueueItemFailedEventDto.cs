...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class QueueItemFailedEventDto :  IEquatable<QueueItemFailedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueItemFailedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueueItemFailedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueItemFailedEventDto" /> class.
        /// </summary>
        ...
        public QueueItemFailedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), WebhookQueueItemDto QueueItem = default(WebhookQueueItemDto), WebhookQueueDefinitionDto Queue = default(WebhookQueueDefinitionDto), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for QueueItemFailedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for QueueItemFailedEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as QueueItemFailedEventDto);
        }

        /// <summary>
        /// Returns true if QueueItemFailedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of QueueItemFailedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueItemFailedEventDto input)
        {
            if (input == null)
                return false;
