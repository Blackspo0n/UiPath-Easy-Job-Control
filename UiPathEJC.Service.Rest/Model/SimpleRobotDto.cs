...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class SimpleRobotDto :  IEquatable<SimpleRobotDto>, IValidatableObject
    {
        /// <summary>
        /// The Robot type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleRobotDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SimpleRobotDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleRobotDto" /> class.
        /// </summary>
        ...
        public SimpleRobotDto(string LicenseKey = default(string), string MachineName = default(string), long? MachineId = default(long?), string Name = default(string), string Username = default(string), string Description = default(string), string Version = default(string), TypeEnum Type = default(TypeEnum), HostingTypeEnum HostingType = default(HostingTypeEnum), string Password = default(string), CredentialTypeEnum? CredentialType = default(CredentialTypeEnum?), List<EnvironmentDto> Environments = default(List<EnvironmentDto>), string RobotEnvironments = default(string), Dictionary<string, Object> ExecutionSettings = default(Dictionary<string, Object>), long? Id = default(long?))
        {
            ...
            if (Username == null)
            {
                throw new InvalidDataException("Username is a required property for SimpleRobotDto and cannot be null");
            }
            else
            {
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for SimpleRobotDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (HostingType == null)
            {
                throw new InvalidDataException("HostingType is a required property for SimpleRobotDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SimpleRobotDto);
        }

        /// <summary>
        /// Returns true if SimpleRobotDto instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleRobotDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleRobotDto input)
        {
            if (input == null)
                return false;
