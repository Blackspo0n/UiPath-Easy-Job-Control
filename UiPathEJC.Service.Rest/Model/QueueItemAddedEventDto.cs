...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class QueueItemAddedEventDto :  IEquatable<QueueItemAddedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueItemAddedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueueItemAddedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueItemAddedEventDto" /> class.
        /// </summary>
        ...
        public QueueItemAddedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), WebhookQueueDefinitionDto Queue = default(WebhookQueueDefinitionDto), List<WebhookQueueItemDto> QueueItems = default(List<WebhookQueueItemDto>), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for QueueItemAddedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for QueueItemAddedEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as QueueItemAddedEventDto);
        }

        /// <summary>
        /// Returns true if QueueItemAddedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of QueueItemAddedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueItemAddedEventDto input)
        {
            if (input == null)
                return false;
