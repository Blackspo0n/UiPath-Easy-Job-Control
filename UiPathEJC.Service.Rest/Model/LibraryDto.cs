...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class LibraryDto :  IEquatable<LibraryDto>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as LibraryDto);
        }

        /// <summary>
        /// Returns true if LibraryDto instances are equal
        /// </summary>
        /// <param name="input">Instance of LibraryDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LibraryDto input)
        {
            if (input == null)
                return false;
