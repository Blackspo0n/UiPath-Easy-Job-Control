...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class ODataPathSegment :  IEquatable<ODataPathSegment>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ODataPathSegment);
        }

        /// <summary>
        /// Returns true if ODataPathSegment instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataPathSegment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataPathSegment input)
        {
            if (input == null)
                return false;
