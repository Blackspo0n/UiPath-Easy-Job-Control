...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class QueueItemCompletedEventDto :  IEquatable<QueueItemCompletedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueItemCompletedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueueItemCompletedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueItemCompletedEventDto" /> class.
        /// </summary>
        ...
        public QueueItemCompletedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), WebhookQueueItemDto QueueItem = default(WebhookQueueItemDto), WebhookQueueDefinitionDto Queue = default(WebhookQueueDefinitionDto), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for QueueItemCompletedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for QueueItemCompletedEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as QueueItemCompletedEventDto);
        }

        /// <summary>
        /// Returns true if QueueItemCompletedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of QueueItemCompletedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueItemCompletedEventDto input)
        {
            if (input == null)
                return false;
