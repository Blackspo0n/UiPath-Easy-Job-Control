...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class PingEventDto :  IEquatable<PingEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PingEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PingEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PingEventDto" /> class.
        /// </summary>
        ...
        public PingEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for PingEventDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for PingEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for PingEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PingEventDto);
        }

        /// <summary>
        /// Returns true if PingEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of PingEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PingEventDto input)
        {
            if (input == null)
                return false;
