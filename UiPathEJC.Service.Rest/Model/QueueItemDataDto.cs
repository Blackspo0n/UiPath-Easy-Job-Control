...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class QueueItemDataDto :  IEquatable<QueueItemDataDto>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueItemDataDto" /> class.
        /// </summary>
        /// <param name="Name">The name of the queue into which the item will be added..</param>
        ...
        public QueueItemDataDto(string Name = default(string), PriorityEnum? Priority = default(PriorityEnum?), Dictionary<string, Object> SpecificContent = default(Dictionary<string, Object>), DateTime? DeferDate = default(DateTime?), DateTime? DueDate = default(DateTime?), string Reference = default(string))
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>The name of the queue into which the item will be added.</value>
        ...
        {
            return this.Equals(input as QueueItemDataDto);
        }

        /// <summary>
        /// Returns true if QueueItemDataDto instances are equal
        /// </summary>
        /// <param name="input">Instance of QueueItemDataDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueItemDataDto input)
        {
            if (input == null)
                return false;
