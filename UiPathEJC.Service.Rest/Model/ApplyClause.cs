...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class ApplyClause :  IEquatable<ApplyClause>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplyClause" /> class.
        /// </summary>
        /// <param name="Transformations">Transformations.</param>
        public ApplyClause(List<TransformationNode> Transformations = default(List<TransformationNode>))
        {
        ...
        {
            return this.Equals(input as ApplyClause);
        }

        /// <summary>
        /// Returns true if ApplyClause instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplyClause to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplyClause input)
        {
            if (input == null)
                return false;
