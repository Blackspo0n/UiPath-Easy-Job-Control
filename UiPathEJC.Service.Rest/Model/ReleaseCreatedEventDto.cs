...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class ReleaseCreatedEventDto :  IEquatable<ReleaseCreatedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseCreatedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReleaseCreatedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseCreatedEventDto" /> class.
        /// </summary>
        ...
        public ReleaseCreatedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), List<WebhookReleaseDto> Releases = default(List<WebhookReleaseDto>), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for ReleaseCreatedEventDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for ReleaseCreatedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for ReleaseCreatedEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ReleaseCreatedEventDto);
        }

        /// <summary>
        /// Returns true if ReleaseCreatedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ReleaseCreatedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReleaseCreatedEventDto input)
        {
            if (input == null)
                return false;
