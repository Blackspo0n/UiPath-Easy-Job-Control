...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class SetTransactionParameters :  IEquatable<SetTransactionParameters>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetTransactionParameters" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetTransactionParameters {\n");
        ...
        {
            return this.Equals(input as SetTransactionParameters);
        }

        /// <summary>
        /// Returns true if SetTransactionParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of SetTransactionParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetTransactionParameters input)
        {
            if (input == null)
                return false;
