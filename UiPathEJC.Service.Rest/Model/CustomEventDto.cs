...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class CustomEventDto :  IEquatable<CustomEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEventDto" /> class.
        /// </summary>
        ...
        public CustomEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), Dictionary<string, Object> EventData = default(Dictionary<string, Object>), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for CustomEventDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for CustomEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for CustomEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CustomEventDto);
        }

        /// <summary>
        /// Returns true if CustomEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomEventDto input)
        {
            if (input == null)
                return false;
