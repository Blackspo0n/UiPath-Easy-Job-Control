...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class QueueUpdatedEventDto :  IEquatable<QueueUpdatedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueUpdatedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueueUpdatedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueUpdatedEventDto" /> class.
        /// </summary>
        ...
        public QueueUpdatedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), List<WebhookQueueDefinitionDto> Queues = default(List<WebhookQueueDefinitionDto>), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for QueueUpdatedEventDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for QueueUpdatedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for QueueUpdatedEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as QueueUpdatedEventDto);
        }

        /// <summary>
        /// Returns true if QueueUpdatedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of QueueUpdatedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueUpdatedEventDto input)
        {
            if (input == null)
                return false;
