...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class ErrorInfo :  IEquatable<ErrorInfo>, IValidatableObject
    {
        ...
        public ErrorInfo(int? Code = default(int?), string Message = default(string), string Details = default(string), List<ValidationErrorInfo> ValidationErrors = default(List<ValidationErrorInfo>))
        {
            this.Code = Code;
