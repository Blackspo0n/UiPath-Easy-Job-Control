...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class StopJobParameters :  IEquatable<StopJobParameters>, IValidatableObject
    {
        /// <summary>
        /// Defines Strategy
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StopJobParameters {\n");
        ...
        {
            return this.Equals(input as StopJobParameters);
        }

        /// <summary>
        /// Returns true if StopJobParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of StopJobParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopJobParameters input)
        {
            if (input == null)
                return false;
