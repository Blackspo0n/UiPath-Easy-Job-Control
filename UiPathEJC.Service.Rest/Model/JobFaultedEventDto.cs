...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class JobFaultedEventDto :  IEquatable<JobFaultedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobFaultedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JobFaultedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JobFaultedEventDto" /> class.
        /// </summary>
        ...
        public JobFaultedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), WebhookSimpleJobDto Job = default(WebhookSimpleJobDto), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for JobFaultedEventDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for JobFaultedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for JobFaultedEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as JobFaultedEventDto);
        }

        /// <summary>
        /// Returns true if JobFaultedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of JobFaultedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobFaultedEventDto input)
        {
            if (input == null)
                return false;
