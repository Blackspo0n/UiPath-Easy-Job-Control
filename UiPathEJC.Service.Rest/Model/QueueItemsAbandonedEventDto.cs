...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class QueueItemsAbandonedEventDto :  IEquatable<QueueItemsAbandonedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueItemsAbandonedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueueItemsAbandonedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueItemsAbandonedEventDto" /> class.
        /// </summary>
        ...
        public QueueItemsAbandonedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), WebhookQueueDefinitionDto Queue = default(WebhookQueueDefinitionDto), List<WebhookQueueItemDto> QueueItems = default(List<WebhookQueueItemDto>), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for QueueItemsAbandonedEventDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for QueueItemsAbandonedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for QueueItemsAbandonedEventDto and cannot be null");
            }
            else
            {
        ...
        public List<WebhookQueueItemDto> QueueItems { get; set; }
        ...
        {
            return this.Equals(input as QueueItemsAbandonedEventDto);
        }

        /// <summary>
        /// Returns true if QueueItemsAbandonedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of QueueItemsAbandonedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueueItemsAbandonedEventDto input)
        {
            if (input == null)
                return false;
