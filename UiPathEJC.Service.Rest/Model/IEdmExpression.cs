...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class IEdmExpression :  IEquatable<IEdmExpression>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IEdmExpression" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as IEdmExpression);
        }

        /// <summary>
        /// Returns true if IEdmExpression instances are equal
        /// </summary>
        /// <param name="input">Instance of IEdmExpression to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IEdmExpression input)
        {
            if (input == null)
                return false;
