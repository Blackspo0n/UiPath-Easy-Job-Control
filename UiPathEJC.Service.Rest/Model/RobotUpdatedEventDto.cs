...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class RobotUpdatedEventDto :  IEquatable<RobotUpdatedEventDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RobotUpdatedEventDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RobotUpdatedEventDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RobotUpdatedEventDto" /> class.
        /// </summary>
        ...
        public RobotUpdatedEventDto(string Type = default(string), string EventId = default(string), DateTime? Timestamp = default(DateTime?), List<WebhookRobotDto> Robots = default(List<WebhookRobotDto>), int? TenantId = default(int?), long? OrganizationUnitId = default(long?), long? UserId = default(long?))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for RobotUpdatedEventDto and cannot be null");
            }
            else
            {
                this.Type = Type;
            ...
            if (EventId == null)
            {
                throw new InvalidDataException("EventId is a required property for RobotUpdatedEventDto and cannot be null");
            }
            else
            {
            ...
            if (Timestamp == null)
            {
                throw new InvalidDataException("Timestamp is a required property for RobotUpdatedEventDto and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RobotUpdatedEventDto);
        }

        /// <summary>
        /// Returns true if RobotUpdatedEventDto instances are equal
        /// </summary>
        /// <param name="input">Instance of RobotUpdatedEventDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RobotUpdatedEventDto input)
        {
            if (input == null)
                return false;
