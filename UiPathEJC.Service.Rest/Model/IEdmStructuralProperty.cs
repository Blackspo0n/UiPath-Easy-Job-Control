...
namespace UiPathEJC.Service.Rest.Model
{
    ...
    public partial class IEdmStructuralProperty :  IEquatable<IEdmStructuralProperty>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IEdmStructuralProperty" /> class.
        /// </summary>
        /// <param name="Type">Type.</param>
        /// <param name="DeclaringType">DeclaringType.</param>
        public IEdmStructuralProperty(IEdmTypeReference Type = default(IEdmTypeReference), IEdmStructuredType DeclaringType = default(IEdmStructuredType))
        {
            this.Type = Type;
        ...
        /// <summary>
        /// Gets or Sets DefaultValueString
        /// </summary>
        [DataMember(Name="DefaultValueString", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DefaultValueString: ").Append(DefaultValueString).Append("\n");
        ...
        {
            return this.Equals(input as IEdmStructuralProperty);
        }

        /// <summary>
        /// Returns true if IEdmStructuralProperty instances are equal
        /// </summary>
        /// <param name="input">Instance of IEdmStructuralProperty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IEdmStructuralProperty input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.DefaultValueString == input.DefaultValueString ||
                    (this.DefaultValueString != null &&
                    this.DefaultValueString.Equals(input.DefaultValueString))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DefaultValueString != null)
                    hashCode = hashCode * 59 + this.DefaultValueString.GetHashCode();
